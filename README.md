...
Public documentation for how we operate our AI assistant infrastructure (Hugo, Kari, Gizmo) running on OpenClaw.

## Contents

- [DevOps Architecture](DEVOPS-ARCHITECTURE-PUBLIC.md) - Infrastructure design, deployment model, resilience strategy
- [SecOps Architecture](SECOPS-ARCHITECTURE-PUBLIC.md) - Security hardening, routines, and procedures
